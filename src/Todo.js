...
export default function Todo({ todo, toggleTodo, updateToDoName, handleDeleteTodo, editing }) {
    ...
    return (
        <div className="input-group mb-3">
            ...
            <input type="text" className="form-control" aria-label="Text input with checkbox" defaultValue={todo.name} onChange={handleNameUpdate} ref={todoNameRef} />
            {editing ?
            <div className="input-group-text">
